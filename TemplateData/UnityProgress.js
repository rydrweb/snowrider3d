...
function UnityProgress(gameInstance, progress) {
    ...
    if (progress >= 0.9 && progress < 1) {
        gameInstance.textProgress.innerHTML = 'Loading, Wait..' + ' <img src="' + rootPath + '/ghost-loading.gif" class="spinner" />';
    } else {
        gameInstance.textProgress.innerHTML = 'Loading - ' + Math.floor(progress * 100) + '%' + ' <img src="' + rootPath + '/ghost-loading.gif" class="spinner" />';
    }
